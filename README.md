...
When committing updates, the first word in the title should represent a noun, something like (adding, updating, removing, changing, moving and etc.) or the more formal way (add, update, remove, change, move and etc.).

We will be using the verb words, such as (added, updated, removed, changed, moved and etc.) to our releases.
